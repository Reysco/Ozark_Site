  ...
  return (
    ...
    >
      ...
      <section className="grid md:grid-cols-2 gap-10 mb-16">
        ...
        <div className="page-card hover-lift">
          <CardHeader>
            ...
            <CardDescription>Negócios que querem evoluir com estrutura.</CardDescription>
          </CardHeader>
        ...
        <div className="page-card hover-lift">
          <CardHeader>
            ...
            <CardDescription>Gestão prática baseada em dados reais.</CardDescription>
          </CardHeader>
          <CardContent className="text-slate-300 space-y-2">
      ...
      <section className="flex flex-col md:flex-row gap-4">
        <Button size="lg" className="flex-1">Agendar conversa</Button>

        <Button size="lg" variant="outline" className="flex-1" asChild>
          <a href="https://www.instagram.com/ozark_consultoria_financeira/" target="_blank">
            Instagram
          </a>
        </Button>
      </section>
